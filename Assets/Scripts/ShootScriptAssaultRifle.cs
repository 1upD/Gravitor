...
public class ShootScriptAssaultRifle : MonoBehaviour
{
    ...
    // Boolean to represent whether the weapon has spread
    ...
    private void Fire()
    {
        ...
        else
        {
            ...
            for (int i = 0; i < 5; i++)
            {
                Quaternion addRotation = Quaternion.Lerp(parentRotation, new Quaternion(Random.Range(0, 10), Random.Range(0, 10), Random.Range(0, 10), Random.Range(0, 10)), 0.001f);
